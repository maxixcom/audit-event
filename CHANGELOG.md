...
### Added
- Добавлена категория действия `REGISTER` в `ActionCategory`

## [0.0.6] - 2026-02-27

### Fixed
- Исправлена ошибка создания GitHub Release: JReleaser теперь явно использует ветку `master` (`branch=master`, `overwrite=true`)
